...
\begin{table}
    ...
    \begin{tabular}{|c|c|}
        ...
        $u[n]-u[n-N]$ & $e^{-j\Omega(N-1)/2}\left[\dfrac{\sin\left(\frac{N\Omega}{2}\right)}{\sin\left(\frac{\Omega}{2}\right)}\right]$ \\[0.5cm]
        $u[n+N]-u[n-(N+1)]$ & $\dfrac{\sin\left[\Omega\left(N+\frac{1}{2}\right)\right]}{\sin\left(\frac{\Omega}{2}\right)}$ \\[0.5cm]
