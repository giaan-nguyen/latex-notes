...
In the previous chapter, we analyzed periodic signals using the Fourier series. However, not all signals are periodic. While the Fourier transform 
...
\begin{tcolorbox}[width=\textwidth,colback={white}, sharp corners]
    The \emph{frequency response function} is the Fourier transform of the impulse response:
    \begin{align}
